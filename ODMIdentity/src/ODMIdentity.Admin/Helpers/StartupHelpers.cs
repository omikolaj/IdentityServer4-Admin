...
using ODMIdentity.Admin.ExceptionHandling;
using ODMIdentity.Admin.Middlewares;
using ODMIdentity.Admin.Configuration;
using ODMIdentity.Admin.Configuration.ApplicationParts;
using ODMIdentity.Admin.Configuration.Constants;
using ODMIdentity.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using ODMIdentity.Admin.Helpers.Localization;
...
namespace ODMIdentity.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void AddAuthenticationServices<TContext, TUserIdentity, TUserIdentityRole>(this IServiceCollection services, IHostingEnvironment hostingEnvironment, IAdminConfiguration adminConfiguration, IConfiguration configuration)
