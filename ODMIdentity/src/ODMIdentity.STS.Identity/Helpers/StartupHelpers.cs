...
using SendGrid;
using Serilog;
using ODMIdentity.STS.Identity.Configuration;
using ODMIdentity.STS.Identity.Configuration.ApplicationParts;
using ODMIdentity.STS.Identity.Configuration.Constants;
using ODMIdentity.STS.Identity.Configuration.Intefaces;
using ODMIdentity.STS.Identity.Helpers.Localization;
using ODMIdentity.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace ODMIdentity.STS.Identity.Helpers
{
